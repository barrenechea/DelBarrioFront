              ...
              <div class="carousel-inner">
                <div class="item active">
                  <div class="col-md-2 col-sm-6">
                    <a href="emprendedor.html"><img v-bind:src="'/static/img/no-image.jpg'" class="img-responsive" alt=""></a>
                ...
                <div class="item">
                  <div class="col-md-2 col-sm-6">
                    <a href="emprendedor.html">
                      <img v-bind:src="'/static/img/no-image.jpg'" class="img-responsive" alt="">
                    </a>
...
export default {
  ...
  mounted () {
    postscontroller.listPosts(this)
  },
  components: {
    truncate
  }
