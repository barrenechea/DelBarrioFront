...
function GET (id = undefined) {
  return axios.get(CFG.apiUrl + 'persona/' + id)
    .then(res => {
      return {
        id: id,
...
function GETAll () {
  return axios.get(CFG.apiUrl + 'persona')
    .then(response => {
      return {
...
function setState (client) {
  console.log(!client.usuario.FLAG_BAN)
  axios.put(
    CFG.apiUrl + 'usuario/' + client.usuario.IDEN_USUARIO,
    {
